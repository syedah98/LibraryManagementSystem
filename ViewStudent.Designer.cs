namespace Library_Management_System
{
    partial class ViewStudent
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Click += new EventHandler(label1_Click); // Correct event handler attachment
            // 
            // button1
            // 
            ...
            button1.Click += new EventHandler(button1_Click); // Correct event handler attachment
            // 
            // textBox1
            // 
            ...
            textBox1.TextChanged += new EventHandler(textBox1_TextChanged); // Correct event handler attachment
            // 
            // label7
            // 
            ...
            Name = "ViewStudent";
            Text = "ViewStudent";
            Load += new EventHandler(ViewStudent_Load); // Correct event handler attachment
